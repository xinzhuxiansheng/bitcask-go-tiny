...
func TestBPlusTree_Put(t *testing.T) {
	path := filepath.Join("E:\\Code\\Go\\bitcask-go-tiny\\doc", "bptree-put")
	...
	res4 := tree.Put([]byte("acc"), &data.LogRecordPos{Fid: 123, Offset: 883})
	assert.Equal(t, uint32(123), res4.Fid)
	assert.Equal(t, int64(999), res4.Offset)
}

func TestBPlusTree_Get(t *testing.T) {
	path := filepath.Join("E:\\Code\\Go\\bitcask-go-tiny\\doc", "bptree-get")
	_ = os.MkdirAll(path, os.ModePerm)
	defer func() {
		_ = os.RemoveAll(path)
	}()
	...
	tree.Put([]byte("abc"), &data.LogRecordPos{Fid: 9884, Offset: 1232})
	pos2 := tree.Get([]byte("aac"))
	assert.NotNil(t, pos2)
}

func TestBPlusTree_Delete(t *testing.T) {
	path := filepath.Join("E:\\Code\\Go\\bitcask-go-tiny\\doc", "bptree-delete")
	_ = os.MkdirAll(path, os.ModePerm)
	defer func() {
		_ = os.RemoveAll(path)
	}()
	...
	assert.Equal(t, uint32(123), res2.Offset)
...
func TestBPlusTree_Size(t *testing.T) {
	path := filepath.Join("E:\\Code\\Go\\bitcask-go-tiny\\doc", "bptree-size")
	_ = os.MkdirAll(path, os.ModePerm)
	defer func() {
		_ = os.RemoveAll(path)
	}()
...
func TestBPlusTree_Iterator(t *testing.T) {
	path := filepath.Join("E:\\Code\\Go\\bitcask-go-tiny\\doc", "bptree-iterator")
	_ = os.MkdirAll(path, os.ModePerm)
	defer func() {
		_ = os.RemoveAll(path)
	}()
